...
describe('ContactsPage', () => {
  ...
  beforeEach(async () => {
    const crmServiceSpy = jasmine.createSpyObj('CrmService', ['getContacts']);
  ...
  it('should display contacts header in the template', () => {
    const compiled = fixture.nativeElement as HTMLElement;
    const header = compiled.querySelector('ion-header ion-toolbar ion-title');
    expect(header?.textContent?.trim()).toBe('Contactos');
  });
  ...
  it('should display contacts placeholder content', () => {
    const compiled = fixture.nativeElement as HTMLElement;
  ...
  it('should have correct page title', () => {
    const compiled = fixture.nativeElement as HTMLElement;
    const title = compiled.querySelector('ion-title');
    expect(title?.textContent?.trim()).toBe('Contactos');
  });
});
